		...
		<div class="IAbd">
			...
			<c:forEach items="${requestScope.itemList }" var="item">
				<li class="IAbdw">
					...
					<p>
						<a class="pro" href="#">${item.itemGoods.goodsName }</a>
						<a class="use" href="#">
							适用税率：10%
							<s></s>
							<u>
					...
					<ul class="IAul">
						<li class="IAtax">¥<u>${item.itemGoods.goodsPrice*0.1}</u></li>
						<li class="price">
							<strong>¥<u>${item.itemGoods.goodsPrice}</u></strong><br>
							<s>${item.itemGoods.goodsPrice*2}元</s>
						</li>
						<li class="num">
							<span class="reduce" itemId="${item.itemId}">-</span>
							<input type="text" value="${item.itemGoodsNum}">
							<span class="add" itemId="${item.itemId}">+</span>
						</li>
						<li class="Lastprice">¥ <u>${item.itemGoods.goodsPrice*item.itemGoodsNum}</u></li>
						<li class="last btn">
...
<%--				 <c:forEach items="${requestScope.itemsList}" var="item">
			...
			<div class="account">
				<ul>
					<li>活动优惠 ：-￥<u>0.00</u></li>
					<li>商品应付总计 ：￥<u>0.00</u></li>
					<li class="main">免关税</li>
					<li class="mprice">￥<u>0.00</u></li>
				</ul>
			</div>
			<div class="IAbdfoot">
