    ...
    <div class="indentAea w1190">
        ...
        <div class="IAbd">
            ...
            <ul class="IAbdArea">
                ...
                <c:forEach items="${requestScope.items.itemGoods}" var="goods">
                    <li class="IAbdw">
                        <span class="lincheck checkbox"></span>
                        <img src="images/cartpro.jpg" data-original="images/${goods.goodsImg}"
                        alt="" width="92px" height="104px">
                        <p>
                            <a class="pro" href="#">
                                <c:choose>
                        ...
                        <ul class="IAul">
                            <li class="IAtax"><u><fmt:formatNumber value="${goods.goodsPrice }/10"  pattern="￥#,###.00" /></u></li>
                            <li class="price">
                                <strong><u><fmt:formatNumber value="${goods.goodsPrice }"  pattern="￥#,###.00" /></u></strong><br>
                            ...
                            <li class="Lastprice"> <u><fmt:formatNumber value="${goods.goodsPrice }"  pattern="￥#,###.00" /></u></li>
                            <li class="last btn">
